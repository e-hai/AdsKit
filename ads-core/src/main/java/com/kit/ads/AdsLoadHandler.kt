 ...
 */
internal class AdsLoadHandler constructor(
    ...
    fun loadAd(context: Context, listener: AdsListener) {
        ...
        val adsProviderListener = object : AdsProviderListener {
            ...
            override fun onAdFailedToLoad(error: String, errorCode: String?) {
                dispatchToMain {
                    AdsLogger.e(TAG, "onAdFailedToLoad id=$triggerId unit=$adUnitId type=$adType provider=$providerType error=$error errorCode=$errorCode")
